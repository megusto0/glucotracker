...
- Журнал питания: ручные записи, быстрые продукты, шаблоны, черновики и принятые записи.
...
- Отчёт для эндокринолога: PDF A4 на один лист из локальных данных, с инсулином, глюкозой до/после еды, `Наблюдаемым УК`, TIR и сводкой по дням.
- Desktop UI: Tauri 2 + React, русский интерфейс, локальное сохранение PDF через системный диалог.
