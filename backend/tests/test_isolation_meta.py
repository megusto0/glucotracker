...
ISOLATION_TEST_ENDPOINTS: set[str] = {
    ...
    "GET /glucose/basal-tests",
    "POST /glucose/basal-tests",
    "PATCH /glucose/basal-tests/{run_id}",
    "GET /glucose/episodes",
    "GET /glucose/episodes/breakdown",
    ...
    "GET /glucose/sensor-codes",
    "POST /glucose/sensor-codes",
    "PATCH /glucose/sensor-codes/{code_id}",
