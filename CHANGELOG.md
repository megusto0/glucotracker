...
- **Android** — «Мой ритм» теперь отдельно показывает флажок конца дня и луну
  типичного сна: каждый дневной значок остаётся в центре своего окна, а луна —
  в геометрическом центре полосы сна. Названия всех периодов приведены к
  единому регистру (`55adb8b`).
