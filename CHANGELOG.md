...
- **Backend / Android (gluco)** — разбор пищевого эпизода больше не скрывает
  связанный с ним инсулин: каждый болюс показан отдельной меткой на графике и
  строкой «Инсулин N ЕД» с точным временем относительно еды, включая поздний
  болюс «через 53 мин после еды» (`f3084e8`).
