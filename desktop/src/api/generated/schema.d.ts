...
export interface paths {
    ...
    "/glucose/prediction": {
         ...
         * @description Return a validated personal forecast for informational display only.
         */
        get: operations["getGlucosePrediction"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        GlucosePredictionInputs: {
            ...
            asleep: boolean;
            /**
             * Carb Absorption Next 30M G
             * @default 0
             */
            carb_absorption_next_30m_g: number;
            /**
             * Carbs G 4H
             * @default 0
             */
             ...
             * @default 0
             */
            cob_remaining_g: number;
            /**
             * Exercise Minutes 3H
             * @default 0
             */
            exercise_minutes_3h: number;
            /** Heart Rate Bpm */
            heart_rate_bpm?: number | null;
            /**
             * Insulin Action Next 30M Units
             * @default 0
             */
            insulin_action_next_30m_units: number;
            /**
             * Insulin Units 5H
             * @default 0
             */
            insulin_units_5h: number;
            /**
             * Iob Remaining Units
             * @default 0
             */
            iob_remaining_units: number;
         ...
         * @description Validation and provenance metadata for the personal model.
         */
        GlucosePredictionModel: {
            /** Algorithm */
            algorithm: string;
            ...
            /**
             * Forecast Assumption
             * @default observed_policy
             * @enum {string}
             */
            forecast_assumption: "observed_policy" | "no_new_food_or_insulin";
            /**
             * Sample Count
             * @default 0
             */
            ...
            /**
             * Validation High Count
             * @default 0
             */
            validation_high_count: number;
            /** Validation High Mae Mmol */
            validation_high_mae_mmol?: number | null;
            /** Validation High Miss Pct */
            validation_high_miss_pct?: number | null;
            /**
             * Validation Low Count
             * @default 0
             */
            validation_low_count: number;
            /** Validation Low Mae Mmol */
            validation_low_mae_mmol?: number | null;
            /** Validation Low Miss Pct */
            validation_low_miss_pct?: number | null;
            /** Validation Mae Mmol */
            validation_mae_mmol?: number | null;
            /** Validation Post Meal Baseline Mae 90 Mmol */
            validation_post_meal_baseline_mae_90_mmol?: number | null;
            /**
             * Validation Post Meal Count
             * @default 0
             */
            validation_post_meal_count: number;
            /** Validation Post Meal Mae 30 Mmol */
            validation_post_meal_mae_30_mmol?: number | null;
            /** Validation Post Meal Mae 60 Mmol */
            validation_post_meal_mae_60_mmol?: number | null;
            /** Validation Post Meal Mae 90 Mmol */
            validation_post_meal_mae_90_mmol?: number | null;
            /** Version */
            version: string;
        };
        /**
         * GlucosePredictionPoint
         * @description One display-only future point from the personal historical model.
         */
        GlucosePredictionPoint: {
            /**
             * Band
         ...
         * @description Personal 90-minute glucose forecast for informational display only.
         */
        GlucosePredictionResponse: {
            /** Anchor Timestamp */
            ...
            /** Horizon Minutes */
            horizon_minutes: number;
            inputs: components["schemas"]["GlucosePredictionInputs"];
            /**
             * Mode
             * @enum {string}
             */
            mode: "raw" | "normalized";
            model: components["schemas"]["GlucosePredictionModel"];
            /** Notes */
            notes?: string[];
            /** Points */
            points: components["schemas"]["GlucosePredictionPoint"][];
            /** Raw Anchor Value */
            raw_anchor_value?: number | null;
            /** Step Minutes */
            step_minutes: number;
        };
        /**
